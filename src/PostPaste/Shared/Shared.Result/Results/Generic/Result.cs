...
public class Result<TData> : Result, IResult<TData>
{
    ...
    private Result(ResultStatus status, IDictionary<string, Error> errors) : base(status, errors) { }
    ...
    public new static Result<TData> Failure(ResultStatus status, IDictionary<string, Error> errors) 
        => new(status, errors);
    
    public new static Result<TData> ValidationFailure(Error error) 
        => new(ResultStatus.ValidationError, error);
    
    public new static Result<TData> ValidationFailure(IDictionary<string, Error> errors) 
    ...
    public new static Result<TData> NotFound(IDictionary<string, Error> errors) 
    ...
    public new static Result<TData> InternalFailure(IDictionary<string, Error> errors) 
